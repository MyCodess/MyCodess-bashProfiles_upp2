...
#--  ======== sfdisk-dumps  for MBR/partition tables ::  !! do NOT use -d for sfdisk/sgdisk !! for sgdisk it means DELETE the whole partiotion !!
sfdisk  --dump  ${HDDevice} > ./${fnPrefix}_sfdiskDump_MBRdisks.sFdisk

#--  ======== sgdisk-dumps For GPT disks ::  !!! do NOT use -d for sfdisk/sgdisk !! for sgdisk it means DELETE the whole partiotion !!
sgdisk  --backup=./${fnPrefix}_sgdiskDump_GPTdisks.sGdisk  ${HDDevice}
