...
export  q_osTg=fed                   #- OS-short-abbrev-name : used for q_syysTg...
...
export  q_syysNoTg=2512               #- MY-assigned-No, just randomly for identifying my system; never changes! usu. the date of very FIRST install YYMM !
export  q_syysCatTg=RF                #- just flag, not used yet. choice: RF, CP, TE (testie), DM (dummy)
export  q_syysTg=${q_syysNoTg}${q_osTg}    #--UNIQUE-ID of a syys !! usu. YYMM<osTg> , as 2601arx
