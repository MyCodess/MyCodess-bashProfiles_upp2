...
ostmpdir1DP='/tmp/1tmp11/'     #- !reboot will delete them in /tmp/ ! here tmp/tr-stuff in case prj/... requires temporary accessible to OS/apps/..., also tempo 1RZ, 1m, ...
ostmpvar1DP='/tmp/1var11/'     #- !reboot will delete them in /tmp/ ! here all tmp-auto-files as caches/vars/... as pycache, pytestcache, ...
